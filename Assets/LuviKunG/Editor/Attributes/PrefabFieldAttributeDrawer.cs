...
namespace LuviKunG.Attribute
{
    ...
    public class PrefabFieldAttributeDrawer : PropertyDrawer
    {
        ...
        {
            PrefabFieldAttribute assetFieldAttribute = (PrefabFieldAttribute)attribute;
            ...
            if (property.propertyType == SerializedPropertyType.ObjectReference)
            {
                ...
                if (assetFieldAttribute.type == null)
                {
                ...
                else
                {
                    ...
                    if (GUI.Button(rectButton, "Select", EditorStyles.miniButton))
                    {
                        ...
                        EditorGUIUtility.ShowObjectPicker<GameObject>(property.objectReferenceValue, false, $"has:{assetFieldAttribute.type.Name}", pickerControlID);
                    }
                }
            }
            else
